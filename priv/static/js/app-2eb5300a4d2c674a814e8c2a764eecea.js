	...
	A3(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(_evancz$elm_graphics$Collage$rect, 10, 10)),
				A2(
				...
				_evancz$elm_graphics$Collage$text(
					_evancz$elm_graphics$Text$fromString('Sheilla'))),
				A2(
				_evancz$elm_graphics$Collage$moveY,
				80.0,
				_evancz$elm_graphics$Collage$toForm(
					A3(_evancz$elm_graphics$Element$image, 40, 40, 'images/test.jpeg')))
			])));
...
require.register("web/elm/SeatingChart", function(exports, require, module) {
